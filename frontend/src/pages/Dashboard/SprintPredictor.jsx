...
const SprintPredictor = () => {
    ...
    const strokeOffset = circumference -
        (circumference * success_probability) / 100;
        ...
        <div className="space-y-8 animate-in fade-in duration-500 pb-12">
            ...
            <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                    <span className={`text-[10px] font-black px-3 py-1.5 rounded-full uppercase ${source === 'ml_model'
                            ? 'bg-[#18bc9c]/10 text-[#18bc9c]'
                            : 'bg-yellow-50 text-yellow-600'
                        }`}>
                        {source === 'ml_model' ? '🤖 ML Model Active' : '⚠ Rule-Based Fallback'}
                    </span>
                    <button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-1 bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center">
                    ...
                    <div className="mt-6 flex items-center gap-2 px-4 py-3 rounded-xl w-full justify-center"
                        style={{
                    ...
                    <p className="text-[11px] text-gray-400 mt-4 text-center leading-relaxed">
                        Predicted for: <b className="text-[#2c3e50]">{sprint_name}</b>
                    </p>
                </div>
                                        ...
                                        <div key={i}>
                                            <div className="flex items-center justify-between mb-1.5">
                                                <div className="flex items-center gap-2">
                                                    {isPositive
                                                        ? <TrendingUp size={14} className="text-[#18bc9c]" />
                    ...
                    <div className="bg-[#2c3e50] p-6 rounded-2xl shadow-xl text-white">
                        ...
                        <div className="space-y-3">
                            {recommendations?.map((rec, i) => (
                                ...
                                >
                                    <div className={`text-[10px] font-black px-2 py-1 rounded shrink-0 ${rec.priority === 'CRITICAL'
